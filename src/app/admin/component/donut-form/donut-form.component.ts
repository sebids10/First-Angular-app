...
@Component({
  ...
  template: `
    <form class="donut-form" #form="ngForm" *ngIf="donut; else loading">
      ...
      <button type="button"   *ngIf="isEdit" class="btn btn--green" (click)="handleDelete(form)">
        Delete
      </button>
      <button type="button" *ngIf="form.touched || isEdit" class="btn btn--gray" (click)="form.resetForm()">
        Reset Form
      </button>
...
export class DonutFormComponent {
  ...
  handleDelete(form: NgForm) {
    if (confirm('Realy delete ' + this.donut.name + '?'))
